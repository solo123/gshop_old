...
class AccessoriesControllerTest < ActionController::TestCase
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post :create, accessory: { brand: @accessory.brand, catalog: @accessory.catalog, info: @accessory.info, name: @accessory.name, price: @accessory.price }
    end
  ...
  test "should update accessory" do
    put :update, id: @accessory, accessory: { brand: @accessory.brand, catalog: @accessory.catalog, info: @accessory.info, name: @accessory.name, price: @accessory.price }
    assert_redirected_to accessory_path(assigns(:accessory))
  end
